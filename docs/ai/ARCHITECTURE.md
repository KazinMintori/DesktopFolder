...
### 2.1 Collection UI
- **`VERIFIED`**: Chromeless form (`FormBorderStyle = FormBorderStyle.None`, `ShowInTaskbar = false`, `DoubleBuffered = true`) with custom rounded region (`CollectionTheme.RadiusWindow = 22`) ([DirectDesktopFolders.cs:1721](file:///C:/Users/Ai/.gemini/antigravity/worktrees/DesktopFolder/create_project_map_documentation/DirectDesktopFolders.cs#L1721), [2369](file:///C:/Users/Ai/.gemini/antigravity/worktrees/DesktopFolder/create_project_map_documentation/DirectDesktopFolders.cs#L2369)).
- **`VERIFIED`**: Background renders `CollectionArtwork.Background` (`DesktopFolders.CollectionBackground.png`) anchored to the bottom with ambient radial glow and dark acrylic veil ([DirectDesktopFolders.cs:2420-2440](file:///C:/Users/Ai/.gemini/antigravity/worktrees/DesktopFolder/create_project_map_documentation/DirectDesktopFolders.cs#L2420-L2440)).
...
- **`VERIFIED`**: Mode toggle: Grid mode (3 cards per row, 106 px or 134 px card height) vs List mode (64 px row height) ([DirectDesktopFolders.cs:1124](file:///C:/Users/Ai/.gemini/antigravity/worktrees/DesktopFolder/create_project_map_documentation/DirectDesktopFolders.cs#L1124), [1742-1743](file:///C:/Users/Ai/.gemini/antigravity/worktrees/DesktopFolder/create_project_map_documentation/DirectDesktopFolders.cs#L1742-L1743), [1946-1948](file:///C:/Users/Ai/.gemini/antigravity/worktrees/DesktopFolder/create_project_map_documentation/DirectDesktopFolders.cs#L1946-L1948)).
...
- **`VERIFIED`**: Current layout version constant is `3` ([DirectDesktopFolders.cs:68](file:///C:/Users/Ai/.gemini/antigravity/worktrees/DesktopFolder/create_project_map_documentation/DirectDesktopFolders.cs#L68)).
